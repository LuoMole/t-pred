...
parser.add_argument('-e', '--epochs', default=40, type=int, help="Specify the number of epochs")
...
dataset_train = MingDataset(file_train_all, aa_tcr, aa_ep)
...
for i in tqdm(range(epoch)):
    ...
    if i == epoch-1:
        torch.save(best_model, 'model_save/word2vec_gru.pth')
        draw_roc(fpr, tpr, roc_auc, 'val_roc')
